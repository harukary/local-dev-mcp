...
if [ "$#" -lt 7 ]; then
  echo "usage: activate-launchd-worker.sh DOMAIN LAUNCH_AGENTS_DIR SERVER_LABEL SERVICE_PORT LEGACY_TUNNEL_LABEL LEGACY_PERSONAL_MINI_TUNNEL_LABEL TUNNEL_LABEL..." >&2
  exit 64
fi
...
SERVER_LABEL="$3"
SERVICE_PORT="$4"
LEGACY_TUNNEL_LABEL="$5"
LEGACY_PERSONAL_MINI_TUNNEL_LABEL="$6"
shift 6
TUNNEL_LABELS=("$@")
